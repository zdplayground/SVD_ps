...
# Copy code from pseudo_KW_stage_IV. -- 11/15/2017
...
parser.add_argument("--odir0", help = "*The basic directory of output files.", required=True)
...
def cal_sn_dep_Cov_cij():
    ...
    #l_in_rank = [158, 99, 133, 167] # the starting l value for each rank 
    l_in_rank = [160,  102,  137,  167]
    for l in range(l_in_rank[rank], num_l_in_rank):
