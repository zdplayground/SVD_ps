...
nrbin=30
mpirun -n 4 ./f2py_TW_zextend_multibin.py --nrbin $nrbin --nkout $nkout --Pk_type Pwig_nonlinear --odir0 "./" --cal_sn True --cal_cijl True --alpha 1.002
mpirun -n 4 ./f2py_TW_zextend_multibin.py --nrbin $nrbin --nkout $nkout --Pk_type Pnow --odir0 "./" --cal_cijl True --alpha 1.002
