! --------------------------------------------------------------------------------------------------
! Copy the same code from the folder ../TW_f2py_SVD, modify sigma_sz to be 0.1(1+z) in the function photo_ni. --03/19/2018
! Need to correct "const" variable in function lens_eff too. It relates to sigma_sz as well. --07/10/2018
! --------------------------------------------------------------------------------------------------
...
! x1, x2 are initial and final boundaries of integration, respectively
    ...
    const = 2.1d0 * 2.0**0.5 * 0.1d0
    erf_z = const*(1.+z_k)  !2.1 factor guarantee 3 sigma precision
